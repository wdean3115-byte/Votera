      ...
      <div className="mx-auto w-full max-w-4xl px-6 py-12">
        <header className="rounded-[28px] border border-white/10 bg-white/5 p-6 shadow-[0_24px_80px_rgba(0,0,0,0.35)]">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-xs uppercase tracking-[0.35em] text-white/50">Office Space</p>
              <h1 className="mt-3 text-3xl font-semibold">Create a Vote</h1>
              <p className="mt-2 text-sm text-white/60">
                Create a poll for your team. Add 1 to 4 options.
              </p>
            </div>
        ...
        <section className="mt-6 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <VoteCreateForm redirectTo="/spaces/tarot" sourceLabel="Office" participantCount={6} />
          </div>
          <VoteSideDashboard
            title="Office members"
            people={[
              { name: "Tushi", status: "online" },
              { name: "Erka", status: "recent" },
              { name: "Bilguun", status: "offline" },
              { name: "Sodoo", status: "online" },
              { name: "Anu", status: "recent" },
              { name: "Zorig", status: "offline" },
            ]}
          />
        </section>
        ...
        <VoteList
          title="Office votes"
          description="Active polls created by your teammates."
        />
